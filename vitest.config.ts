...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@provablehq/veil-bridge/agent': path.resolve(__dirname, 'packages/bridge/src/agent/index.ts'),
      '@provablehq/veil-bridge/mcp': path.resolve(__dirname, 'packages/bridge/src/mcp/index.ts'),
      '@provablehq/veil-bridge': path.resolve(__dirname, 'packages/bridge/src/index.ts'),
      '@provablehq/veil-wallet-adapter': path.resolve(__dirname, 'packages/wallet-adapter/src/index.ts'),
      '@provablehq/veil-sdk': path.resolve(__dirname, 'packages/provable-sdk/src/index.ts'),
      '@provablehq/veil-leo': path.resolve(__dirname, 'packages/leo/src/index.ts'),
      '@provablehq/veil-devnode': path.resolve(__dirname, 'packages/devnode/src/index.ts'),
    },
  },
})

...
| [`@veil/provable-sdk`](./provable-sdk) | Local accounts, signing, and proving via `@provablehq/sdk`. Build a client from a private key. |
...
- **Read-only or server-side?** `@veil/core` + `@veil/provable-sdk`.

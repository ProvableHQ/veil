...
describe('pinned shield_swap ABI', () => {
  it('parses and contains the core entrypoints', () => {
    ...
    for (const m of ['pools', 'slots', 'swap_outputs', 'used_blinded_addresses', 'from_wrapper_token_id', 'to_wrapper_token_id', 'pool_creators', 'swap_execution_headers', 'swap_execution_hops']) {

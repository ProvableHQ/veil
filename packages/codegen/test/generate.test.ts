...
describe('generate', () => {
  describe('header', () => {
    ...
    it('uses custom core import path', () => {
      ...
      expect(output).toContain("import type { RecordValue } from '../core'")
    })
  })

...
caller using the convenience factory was fixed at the 5-minute default and had to
compose the proving config by hand to change it. Multi-hop swaps exceed that — one

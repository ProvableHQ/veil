...
//
// In production, you'd use @provablehq/veil-wallet-adapter's fromWalletAdapter()
...
//
// In production, you'd use @provablehq/veil-sdk's privateKeyToAccount()
...
function setupLocalAccountClient(): { publicClient: PublicClient; walletClient: WalletClient } {
  ...
  // from @provablehq/veil-sdk, using the SDK's ProgramManager
  const proving = {

...
export interface WrappedTokenRegistryContract {
  ...
  write: {
    deposit_token_public_signer: (params: { amount: bigint } & { fee?: bigint }) => Promise<string>
    withdraw_token_public: (params: { amount: bigint } & { fee?: bigint }) => Promise<string>
    withdraw_token_public_signer: (params: { amount: bigint } & { fee?: bigint }) => Promise<string>
    withdraw_token_private: (params: { amount: bigint } & { fee?: bigint }) => Promise<string>
  ...
  simulate: {
    deposit_token_public_signer: (params: { amount: bigint }) => Promise<FutureValue>
    withdraw_token_public: (params: { amount: bigint }) => Promise<FutureValue>
    withdraw_token_public_signer: (params: { amount: bigint }) => Promise<FutureValue>
    withdraw_token_private: (params: { amount: bigint }) => Promise<[RecordValue, FutureValue]>
  ...
  execute: {
    deposit_token_public_signer: (params: { amount: bigint } & { fee?: bigint }) => Promise<{ transactionId: string, result: FutureValue }>
    withdraw_token_public: (params: { amount: bigint } & { fee?: bigint }) => Promise<{ transactionId: string, result: FutureValue }>
    withdraw_token_public_signer: (params: { amount: bigint } & { fee?: bigint }) => Promise<{ transactionId: string, result: FutureValue }>
    withdraw_token_private: (params: { amount: bigint } & { fee?: bigint }) => Promise<{ transactionId: string, result: [RecordValue, FutureValue] }>
